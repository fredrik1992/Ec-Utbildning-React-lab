...
function HandleEmployeeData ()  {
  ...
  function addEmployeeForm(displayOrNotForm) {document.getElementById("formDisplay").style.display =displayOrNotForm}
 function showForm() {
  ...
  window.addEventListener("DOMContentLoaded", getFromLocalStorage());
    ...
    return(
      ...
      <div className="App">
          ...
          <button className ="buttonToAddEmployee" onClick={  showForm }>Add Hunter</button>
        
          <Form closeForm = {showFormOrnot} saveData = {saveToLocalStorage} addData = {addToEmployees} changeOfState = {changeStateOfElement}></Form>
